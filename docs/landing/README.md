...
## Upgrade Path
1. Download the latest AiMentor package from the [GitHub Releases asset](https://github.com/aimentor/aimentor-elementor/releases/download/v0.0.001/aimentor-elementor-v0.0.001.zip) (replace the version in the URL with the currently promoted tag).
